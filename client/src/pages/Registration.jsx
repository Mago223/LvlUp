...
export default function Registration() {
  return (
    <div className="form">
      <div
        id="formCard"
        className="bg-[#1F2025] text-[#181028] p-20  shadow-2xl rounded-xl max-w-full"
      >
        ...
        <form>
          ...
          <div className="mt-10 flex flex-col items-center gap-y-8 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-8">
            {/* First Name Segment */}
