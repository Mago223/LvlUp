...
var chunk_WJD7GF2F_exports = {};
__export(chunk_WJD7GF2F_exports, {
  downloadZip: () => downloadZip,
  require_is_stream: () => require_is_stream,
  require_temp_dir: () => require_temp_dir
});
module.exports = __toCommonJS(chunk_WJD7GF2F_exports);
...
var require_del = (0, import_chunk_AH6QHEOA.__commonJS)({
  "../../node_modules/.pnpm/del@6.1.1/node_modules/del/index.js"(exports, module2) {
    ...
    var isGlob = require_is_glob();
    var slash = require_slash();
    var gracefulFs = (0, import_chunk_5T2KHPZI.require_graceful_fs)();
...
async function fetchChecksum(url) {
  try {
    ...
    const response = await fetch(checksumUrl, {
      agent: (0, import_chunk_RJCNBAHR.getProxyAgent)(url)
    });
    if (!response.ok) {
...
async function downloadZip(url, target, progressCb) {
  ...
  await (0, import_chunk_5T2KHPZI.overwriteFile)(partial, target);
  try {
    await del(partial);
    await del(tmpDir);
  } catch (e) {
