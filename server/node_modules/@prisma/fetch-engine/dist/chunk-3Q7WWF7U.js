...
var chunk_3Q7WWF7U_exports = {};
__export(chunk_3Q7WWF7U_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_3Q7WWF7U_exports);
...
var require_stream = (0, import_chunk_AH6QHEOA.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/stream.js"(exports, module2) {
    "use strict";
    var isStream = (0, import_chunk_WJD7GF2F.require_is_stream)();
...
var import_temp_dir = (0, import_chunk_AH6QHEOA.__toESM)((0, import_chunk_WJD7GF2F.require_temp_dir)());
...
async function downloadBinary(options2) {
  ...
  const { sha256, zippedSha256 } = await (0, import_chunk_WJD7GF2F.downloadZip)(downloadUrl, targetFilePath, progressCb);
  if (progressCb) {
    progressCb(1);
  }
